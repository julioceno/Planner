...
export function Activities({ tripDetails }: Props) {
  ...
  async function getTripActivities() {
    try {
      ...
      const activitiesGrouped = activities.reduce((accumulator: any, activity) => {
        console.log(activity)
        const day = dayjs(activity.occurs_at).format('DD/MM/YYYY')
        ...
        const value = {
          title: {
            dayNumber: dayjs(activity.occurs_at).date(),
            dayName: dayjs(activity.occurs_at).format("dddd").replace("-feira", ""),
          },
          data: activities.filter(item => {
            const currentDate = dayjs(item.occurs_at).format('DD/MM/YYYY')
      ...
      const activitiesToSectionList = Object.values(activitiesGrouped) as TripActivities[]
